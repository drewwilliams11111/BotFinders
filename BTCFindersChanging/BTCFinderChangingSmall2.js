...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderChangingSmall2')
    ...
    await helperMongo.updateCollection('BTCFinderChangingSmall2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()