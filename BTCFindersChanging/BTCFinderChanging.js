...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderChanging')
    ...
    await helperMongo.updateCollection('BTCFinderChanging', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()