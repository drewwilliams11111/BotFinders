...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderChangingSmall')
    ...
    await helperMongo.updateCollection('BTCFinderChangingSmall', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()