...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderChanging2Loss')
    ...
    await helperMongo.updateCollection('BTCFinderChanging2Loss', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()