...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderChanging2LossSmall2')
    ...
    await helperMongo.updateCollection('BTCFinderChanging2LossSmall2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()