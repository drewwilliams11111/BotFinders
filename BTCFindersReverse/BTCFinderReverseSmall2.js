...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderReverseSmall2')
    ...
    await helperMongo.updateCollection('BTCFinderReverseSmall2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()