...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderReverseSmall')
    ...
    await helperMongo.updateCollection('BTCFinderReverseSmall', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()