...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderReverse')
    ...
    await helperMongo.updateCollection('BTCFinderReverse', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()