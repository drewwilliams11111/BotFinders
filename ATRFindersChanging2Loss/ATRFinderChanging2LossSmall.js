...
const runATRFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('ATRFinderChanging2LossSmall')
    ...
    await helperMongo.updateCollection('ATRFinderChanging2LossSmall', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runATRFinderBot()