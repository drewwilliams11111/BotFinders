...
const runATRFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('ATRFinderChanging2LossSmall2')
    ...
    await helperMongo.updateCollection('ATRFinderChanging2LossSmall2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runATRFinderBot()