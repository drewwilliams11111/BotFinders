...
const runATRFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('ATRFinderChangingSmall')
    ...
    await helperMongo.updateCollection('ATRFinderChangingSmall', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runATRFinderBot()