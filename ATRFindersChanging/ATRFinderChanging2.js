...
const runATRFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('ATRFinderChanging2')
    ...
    await helperMongo.updateCollection('ATRFinderChanging2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runATRFinderBot()