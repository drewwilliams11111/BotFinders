...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinder')
    ...
    await helperMongo.updateCollection('BTCFinder', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()