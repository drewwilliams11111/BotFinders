...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinder2')
    ...
    await helperMongo.updateCollection('BTCFinder2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()