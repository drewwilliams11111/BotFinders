...
const runBTCFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('BTCFinderSmall2')
    ...
    await helperMongo.updateCollection('BTCFinderSmall2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runBTCFinderBot()