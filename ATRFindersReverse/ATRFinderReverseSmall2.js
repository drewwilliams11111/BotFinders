...
const runATRFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('ATRFinderReverseSmall2')
    ...
    await helperMongo.updateCollection('ATRFinderReverseSmall2', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runATRFinderBot()