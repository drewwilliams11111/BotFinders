...
const runATRFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('ATRFinderReverseSmall')
    ...
    await helperMongo.updateCollection('ATRFinderReverseSmall', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runATRFinderBot()