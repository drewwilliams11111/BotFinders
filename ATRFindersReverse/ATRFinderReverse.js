...
const runATRFinderBot = async () => {
    ...
    const collectionInfoCoins = await helperMongo.getCollectionInfo('ATRFinderReverse')
    ...
    await helperMongo.updateCollection('ATRFinderReverse', collectionInfoCoins[0]._id, 'allCoins', allCoins)
}
runATRFinderBot()